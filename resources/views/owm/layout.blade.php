...
<head>
    ...
    <script src="https://kit.fontawesome.com/5056edc9a6.js" crossorigin="anonymous"></script>
...
<body>
    ...
    {{-- @include('owm.partials.toastMessage') --}}
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Aries India Technology</span></strong>. All Rights Reserved
        </div>
    ...
    <script src="{{ asset('assets/js/toastMessage.js') }}"></script>
